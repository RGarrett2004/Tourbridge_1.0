                            ...
                            {opportunities.map(opp => (
                                <div key={opp.id} className="bg-gray-900/40 border border-gray-800 p-6 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8 group hover:border-blue-500/30 transition-all relative overflow-hidden">
                                    ...
                                    <div className="flex items-center gap-6 flex-1 min-w-[300px]">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3 mb-1">
                                                <h3 className="text-xl font-black text-white uppercase tracking-tighter leading-none">{opp.venueName}</h3>
                                    ...
                                    <div className="flex items-center gap-4 shrink-0">
                                        ...
                                        <button onClick={() => { setActivePitch(opp); handleGeneratePitch(opp); }} className="p-3 bg-gray-800 hover:bg-purple-600/20 text-gray-400 hover:text-purple-400 rounded-xl transition-all border border-gray-700" title="Draft Pitch with AI" >
                                            <Sparkles size={18} />
                                        </button>
                                        <button onClick={() => handleRemoveOpportunity(opp.id)} className="p-3 bg-gray-800 hover:bg-red-500/20 text-gray-400 hover:text-red-500 rounded-xl transition-all border border-gray-700" title="Discard Lead" >
                                            <Trash2 size={18} />
                                        </button>
                                    </div>
                                </div>
